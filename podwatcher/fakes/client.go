...
import (
	...
	v1beta1j "k8s.io/client-go/kubernetes/typed/networking/v1beta1"
	v1alpha1c "k8s.io/client-go/kubernetes/typed/node/v1alpha1"
	v1beta1k "k8s.io/client-go/kubernetes/typed/node/v1beta1"
	v1beta1l "k8s.io/client-go/kubernetes/typed/policy/v1beta1"
	v1i "k8s.io/client-go/kubernetes/typed/rbac/v1"
	v1alpha1d "k8s.io/client-go/kubernetes/typed/rbac/v1alpha1"
	v1beta1m "k8s.io/client-go/kubernetes/typed/rbac/v1beta1"
	v1j "k8s.io/client-go/kubernetes/typed/scheduling/v1"
	v1alpha1e "k8s.io/client-go/kubernetes/typed/scheduling/v1alpha1"
	v1beta1n "k8s.io/client-go/kubernetes/typed/scheduling/v1beta1"
	v1alpha1f "k8s.io/client-go/kubernetes/typed/settings/v1alpha1"
	v1k "k8s.io/client-go/kubernetes/typed/storage/v1"
	v1alpha1g "k8s.io/client-go/kubernetes/typed/storage/v1alpha1"
	v1beta1o "k8s.io/client-go/kubernetes/typed/storage/v1beta1"
)
...
type FakeInterface struct {
	...
	networkingV1beta1Returns struct {
		result1 v1beta1j.NetworkingV1beta1Interface
	}
	...
	nodeV1beta1Returns struct {
		result1 v1beta1k.NodeV1beta1Interface
	}
	...
	policyV1beta1Returns struct {
		result1 v1beta1l.PolicyV1beta1Interface
	}
	...
	rbacV1beta1Returns struct {
		result1 v1beta1m.RbacV1beta1Interface
	}
	...
	schedulingV1beta1Returns struct {
		result1 v1beta1n.SchedulingV1beta1Interface
	}
	...
	settingsV1alpha1Returns struct {
		result1 v1alpha1f.SettingsV1alpha1Interface
	}
	...
	storageV1beta1Returns struct {
		result1 v1beta1o.StorageV1beta1Interface
	}
...
func (fake *FakeInterface) DiscoveryV1beta1() v1beta1g.DiscoveryV1beta1Interface {
	...
	if fake.DiscoveryV1beta1Stub != nil {
		return fake.DiscoveryV1beta1Stub()
	}
	if specificReturn {
		return ret.result1
	}
...
func (fake *FakeInterface) FlowcontrolV1alpha1() v1alpha1b.FlowcontrolV1alpha1Interface {
	...
	if fake.FlowcontrolV1alpha1Stub != nil {
		return fake.FlowcontrolV1alpha1Stub()
	}
	if specificReturn {
		return ret.result1
	}
